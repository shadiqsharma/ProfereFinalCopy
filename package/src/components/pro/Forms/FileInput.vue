  ...
  <form :class="formClass">
    ...
    <div class="file-field">
      <div :class="btnClass">
        ...
        <input v-if="img" type="file" :accept="accept" @change="(e)=>fileChange(e.target.files)" ref="fileInput" />
        <input v-else type="file" :accept="accept" :multiple="multiple" @change="(e)=>fileChange(e.target.files)" ref="fileInput" />
      </div>
