<template>
  <li :class="className" @click="select" tabindex="0" @keydown.enter.stop="select(true)" @keydown.space.stop="select" class="option" role="option" :aria-selected="active" :aria-disabled="disabled" @mouseover="hover = true" @mouseleave="hover = false">
