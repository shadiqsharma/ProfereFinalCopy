                        ...
                        <div class="row mtn-30">
                            <div class="col-md-5 col-sm-6 col-12 mt-30" data-aos="fade-up">
                                <div class="about-funfact">
                                    <div class="number"><countTo :startVal='0' :endVal='200' :duration='8000' :autoplay="true"></countTo>+</div>
                            ...
                            <div class="col-md-5 col-sm-6 col-12 mt-30" data-aos="fade-up">
                                <div class="about-funfact">
                                    <div class="number"><countTo :startVal='0' :endVal='250' :duration='8000' :autoplay="true"></countTo>+</div>
